...
1. **Источник истины** — **EC Service Manual (PDF)** по ссылке в §2.1. В нём должно быть указано, на какой ОС приложение тестировалось/поддерживается (скорее всего Debian 12). Это и есть «исходные требования» от вендора. *Из нашего плана (§5) известен указанный официальный стек ЕК: Debian 12, OpenJDK 1.8, Tomcat 9.0.102, MySQL 8.0.41 — полный перечень требований нужно смотреть в PDF на сайте ЕК.*
